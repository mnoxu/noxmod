...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.05, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.05,
	...
	ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT = 0.05, -- Crimefight depends on both state admin eff. and admin spending, admin spending percent effect is set to (1-ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT)
	...
	MIN_DELAY_BETWEEN_REFORMS = 4, -- months
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 4, -- can loan max % of country tax base from single country
...
military = {
	...
	AI_SPECIAL_PROPORTION = 0.00, -- fraction of brigades that should be engineers and tanks
...
pops = {
	...
	PROMOTION_ASSIMILATION_CHANCE = 1.5,
